...
class Project(ConanFile):
    ...
    def requirements(self):
        self.requires("coco-ieee802154/pow10", options={"platform": self.options.platform})
        self.requires("coco-zigbee/main", options={"platform": self.options.platform})
        self.requires("coco-pcap/main", options={"platform": self.options.platform})
